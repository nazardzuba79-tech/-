...
## Доповнення v3 (2026-09-23)
18. Backtest-цифри v1/v2 містили помилки механіки (див. `docs/AUDIT_v3_UA.md`); IC були правильні. Виправлені результати — `systems_v3/`.
19. Чесний walk-forward (відбір лише на минулих даних) не підтвердив жодної системи. Будь-яке «підтвердження» з v1/v2 треба читати з цією поправкою.
20. CYCLE: ~3–8 незалежних спостережень; навіть інтервал, що не містить 0, при такій кількості блоків ненадійний.
21. ETH-перевірка напівнезалежна: доходи ETH і BTC корелюють, частина входів спільна.
22. Тижневий графік FRED H.10 — припущення з графіка релізів ФРС, узгоджене з двома спостереженнями (22–23.09.2026), але не перевірене через ALFRED (сервер недоступний).
23. Журнал прямого тесту почато 2026-09-23 з даними до 2026-09-22. Щоб він мав сенс, його треба оновлювати щодня (`./update_all.sh`); перші висновки можливі не раніше ніж через кілька місяців (для CYCLE — роки).
24. Pine-скрипти v3 перевірені лише офлайн-парсером синтаксису; компіляція і backtest у TradingView не виконувались.
