...
const complete: CollateralValuation = { settleAsset: 'USDT', lines: [], priced: '0', collateralPriced: '0', collateralUnpriced: [], unpriced: [], complete: true, asOf: null };
...
describe('the engine decides on the journaled wallet valuation, not on the settle row alone', () => {
  ...
  test('the account response is the engine account: nothing is added twice', () => {
    ...
    const engine = demoAccount(s);
    const valuation: CollateralValuation = { settleAsset: 'USDT', lines: [], priced: '10000', collateralPriced: '10000', collateralUnpriced: [], unpriced: [], complete: true, asOf: 1 };
