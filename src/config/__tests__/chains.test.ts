...
describe('loadChainConfig', () => {
  ...
  // BSC gets the same zero-config RPC default treatment as Ethereum (see
  // DEFAULT_RPC_URL) — verified below. Other EVM chains (Polygon,
  // Avalanche, Arbitrum, ...) have no universal free default and still
  // need their own explicit *_RPC_URL.
  it('throws when a non-Ethereum, non-BSC EVM chain is missing its RPC URL', () => {
  ...
  it('defaults BSC to its own free public RPC endpoint, same as Ethereum', () => {
