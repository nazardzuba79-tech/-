...
const bankingReadabilityCssPath = path.join(frontend, 'src/pages/banking/BankingReadability.css');
...
pageSource = pageSource
  ...
  .replace("import './banking/BankingReadability.css';", `import ${JSON.stringify(bankingReadabilityCssPath)};`);
...
const reviewCss=`
html,body,#root{margin:0;min-height:100%;background:#f5f3ee}.review-nav{height:58px;display:flex;align-items:center;gap:28px;padding:0 30px;background:#fffefa;border-bottom:1px solid #d3d3ca;color:#39443f;font-family:Arial,Helvetica,sans-serif}.review-logo{font-weight:850;letter-spacing:.12em;font-size:20px;color:#1f2925}.review-nav nav{display:flex;gap:25px;align-items:stretch;height:100%}.review-nav nav span{display:flex;align-items:center;position:relative;font-size:13px;font-weight:500;white-space:nowrap}.review-nav nav .active{color:#6b4f21;font-weight:750}.review-nav nav .active:after{content:'';position:absolute;height:2px;left:0;right:0;bottom:0;background:#ad843d}.review-badge{margin-left:auto;border:1px solid #c9b78d;background:#f6eedc;border-radius:5px;padding:5px 8px;font-size:10px;color:#654f28;font-weight:700;letter-spacing:.08em}.review-note{position:fixed;z-index:2000;right:18px;bottom:18px;max-width:310px;padding:10px 12px;border-radius:8px;background:#2d312f;color:#f8f4e9;font:12px/1.5 Arial,Helvetica,sans-serif;box-shadow:0 8px 28px #0002}.review-note b{color:#e8cc91}@media(max-width:800px){.review-nav{height:54px;padding:0 16px}.review-nav nav{overflow:auto;gap:16px}.review-nav nav span:nth-child(n+5){display:none}.review-logo{font-size:17px}.review-badge{display:none}.review-note{left:12px;right:12px;bottom:12px;max-width:none}}
`;
