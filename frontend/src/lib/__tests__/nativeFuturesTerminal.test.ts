...
describe('the adapter projects native state into the terminal shapes', () => {
  ...
  test('an initialised account projects all four resources from one payload', () => {
    const state = adapter.nativeAccountState({
      ...
      account: { walletBalance: '10000', initialDeposit: '10000', unrealizedPnl: '500', equity: '10500', usedMargin: '1500', orderReserve: '200', available: '8300', maintenanceMargin: '150', maintenanceRatio: null, liquidatable: false, deficit: '0' },
