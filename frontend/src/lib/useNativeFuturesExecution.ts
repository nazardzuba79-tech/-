...
const failureOf=(e:unknown,fallback:string)=>e instanceof PrivateTradingError?e:new PrivateTradingError(e instanceof Error&&e.message?e.message:fallback,409);
