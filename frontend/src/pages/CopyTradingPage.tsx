...
export function CopyTradingPage() {
  ...
  useEffect(() => {
    ...
    const refresh = () => {
      ...
      if (import.meta.env.MODE === 'review') void api.getKseniaReview().then(data => { if (!disposed) setKsenia(data); }).catch(() => {});
    };
    refresh();
      ...
      <div className="app">
        <div className="content-wrap">
          ...
          <CopyEligibilityProvider depositUsd={depositUsd} isAdmin={isAdmin}>
            <FeaturedAvatarProvider ownerAvatar={identities.find(i => i.traderId === nazarTrader.id)?.avatarUrl}>
              {view === 'marketplace'
