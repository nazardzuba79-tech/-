...
const en = { gold: 'Gold', oil: 'Oil', quote: 'Reference quote', pause: 'Pause hero motion', resume: 'Resume hero motion',
  live: 'Live', snapshot: 'Market snapshots', unavailable: 'Data unavailable', globe: 'Global markets', field: 'A more connected financial world' };
export const globalHeroCopy: Record<Lang, typeof en> = {
  ...
  zh: { gold: '黄金', oil: '原油', quote: '参考报价', pause: '暂停动态效果', resume: '继续动态效果', live: '实时', snapshot: '市场快照', unavailable: '数据不可用', globe: '全球市场', field: '更加互联的金融世界' },
