  ...
  return (
    <section id="faq" className="vc-bg-voltex-cream vc-px-5 vc-py-24 vc-text-voltex-creamText sm:vc-px-8 lg:vc-px-12 lg:vc-py-36">
      <div className="vc-mx-auto vc-grid vc-max-w-[1344px] vc-gap-14 lg:vc-grid-cols-[0.52fr_1fr]">
        <div><p className="vc-text-[11px] vc-font-semibold vc-uppercase vc-tracking-wide3 vc-text-black/75">Questions &amp; answers</p><h2 className="vc-mt-7 vc-text-[clamp(3.2rem,5vw,5.8rem)] vc-font-medium vc-leading-[0.95] vc-tracking-[-0.06em]">Частые вопросы.</h2></div>
