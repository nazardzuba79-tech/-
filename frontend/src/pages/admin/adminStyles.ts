...
export const styles: Record<string, CSSProperties> = {
  ...
  page: { ...LIGHT_THEME_VARS, minHeight: '100vh', background: 'var(--bg)', color: 'var(--text-primary)', fontWeight: 500, display: 'grid', gridTemplateColumns: '216px minmax(0, 1fr)', fontSize: 13 },
  sidebar: {
  ...
  main: { padding: '16px 24px 24px', minWidth: 0 },
  title: { fontSize: 21, marginBottom: 10, fontFamily: 'var(--font-display)', fontWeight: 700, letterSpacing: '-0.02em' },
  subtitle: { fontSize: 13, color: 'var(--text-secondary)', margin: '0 0 16px' },
  card: {
    background: 'var(--panel)',
    border: '1px solid var(--border)',
    borderRadius: 9,
  ...
  row: { display: 'flex', justifyContent: 'space-between', padding: '7px 0', borderBottom: '1px solid var(--border)' },
