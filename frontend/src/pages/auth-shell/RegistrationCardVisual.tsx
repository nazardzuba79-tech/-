...
/** Registration-only product artwork. Exact physical masters, unwarped and fully
 * visible; the phone is a deterministic vector mockup, not an account view. */
export function RegistrationCardVisual() {
  const id = useId().replace(/:/g, '');
  return <svg viewBox="0 0 690 610" role="img"
    aria-label="VOLTEX Titanium, VOLTEX Black Signature · Crypto Card"
    data-registration-card-composition="two-cards-phone"
    style={{ display: 'block', width: '100%', height: 'auto', maxWidth: 320, overflow: 'visible' }}>
    <defs>
