...
This report was imported as reviewed PR #123 design context. For the final integration's execution provenance, validation results and limitations, see [final-integration.md](final-integration.md).
